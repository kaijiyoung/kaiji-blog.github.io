;(function(factory) {
    ...
    var cssSelector = {
        ...
        'btn': '.magnify-btn',
        'fullScreen': '.magnify-btn-fullScreen'
    };
    var defaults = {
        draggable: false,
        resizable: false,
    ...
    magnify.prototype = {
        ...
        open: function() {
            ...
            this.addEvents();
            this.setModalPos(this.$magnify,true);
        ...
        createDOM: function() {
            var btnTpl = {
                ...
                fullScreen: '<a href="javascript:void(0)" class="magnify-btn magnify-btn-fullScreen" title="' + this.settings.i18n.fullScreen + '"></a>'
            };
        ...
        setModalPos: function(modal, fullScreen) {
            var winWidth = $W.width()
            , winHeight = $W.height()
        ...
        loadImg: function(imgSrc, tag) {
            ...
            // imgSrc = 'http://www.jq22.com/demo/testImg201807311236/images/b1.jpg';
        ...
        addEvents: function() {
            ...
            this.$fullScreen.off(EVENTS.CLICK + EVENTS.EVENT_NS).on(EVENTS.CLICK + EVENTS.EVENT_NS, function() {
                console.log(4555)
                self.setModalPos(self.$magnify,true);
            });
